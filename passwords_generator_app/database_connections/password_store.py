...
class PasswordStore(LocalDatabaseConnector):
    ...
    def insert_update_into_tb(
        self, description: str, password: str, length: int, has_repeatable: bool
    ):
        self.cur.execute(
            """
    ...
    def update_existing_password(
        self, password: str, length: int, has_repeatable: bool, description: str
    ):
        old_password = self.select_password_by_description(description)
