...
from customtkinter import CTkToplevel, ThemeManager, CTkLabel, CTkEntry, CTkButton


class MyCTkInputDialog(CTkToplevel):
    def __init__(
            self,
            ...
            title: str = 'CTkDialog',
            text: str = 'CTkDialog',
            button_options: Tuple[str, str] = ('Ok', 'Cancel')
    ):
        ...
        self._text = text
        self._button_options = button_options

        self.title(title)
        self.lift()
        self.attributes('-topmost', True)
        self.protocol('WM_DELETE_WINDOW', self._on_closing)
        self.after(10, self._create_widgets(self._button_options))
        self.resizable(False, False)
        self.grab_set()

    def _create_widgets(self, input_button_options: Tuple[str, str]):
